                ...
                <form [formGroup]="formOtro">
                    <div class="flex flex-col md:flex-row gap-x-4 gap-y-2">
                        ...
                        <div class="flex flex-col gap-2 w-full">
                            ...
                            <app-input-validation [form]="formOtro" modelo="titulo" ver="titulo"></app-input-validation>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
                        ...
                        <div class="flex flex-col gap-2 w-full">
                            ...
                            <app-input-validation [form]="formOtro" modelo="especialidad" ver="especialidad"></app-input-validation>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-6 gap-4"></div>
                    <div class="flex flex-col md:flex-row gap-x-4 gap-y-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-x-4 gap-y-2">
                        ...
                        <div class="flex flex-col gap-2 w-full">
                            ...
                            <app-input-validation [form]="formOtro" modelo="notasTesis" ver="notasTesis"></app-input-validation>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
...
export class ModalTesisComponent implements OnInit {
    ...
    constructor(
        ...
        this.formOtro = this.fb.group({
            ...
            pais: [this.objetoOtro?.pais, [Validators.required]],
            ciudad: [this.objetoOtro?.ciudad, [Validators.required]],
            cantidad: [this.objetoOtro?.cantidad, [Validators.required, Validators.maxLength(100), Validators.pattern('^[0-9]+$')]],
            anio: [this.objetoOtro?.anio, [Validators.required, Validators.maxLength(4), Validators.pattern('^[0-9]+$')]],
    ...
    async ListaEspecialidad() {
        try {
            ...
            if (result.status == 0) {
                this.especialidadLista = result.data.map(
                    (e: any) =>
                        new Especialidad({
