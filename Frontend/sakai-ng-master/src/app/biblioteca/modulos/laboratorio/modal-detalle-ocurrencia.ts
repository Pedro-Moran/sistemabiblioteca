    ...
    template: ` <p-dialog [(visible)]="display" [style]="{width: '75%'}"  header="Detalle de ocurrencia" [modal]="true" [closable]="true" styleClass="p-fluid" [contentStyle]="{overflow: 'visible'}">
     <ng-template pTemplate="content">
      ...
      dateFormat="dd/mm/yy">
                ...
                <div class="flex flex-col gap-2 col-span-7 lg:col-span-3">
                    <label for="auditoriaPrestamo"><b>Auditoria préstamo</b></label>
                    <p>NOMBRES - 02 - 06/03/2025</p>
                    </div>
                <div class="flex flex-col gap-2 col-span-7 lg:col-span-4">
                ...
                <p-button label="PAGO PENDIENTE" severity="danger" text />
